...
def propagate_modes_wofry(beamline, specific, directory_name,maximum_mode=None):
...
if __name__ == "__main__":
    ...
    if method == 'SRW':
        ...
        beamlineWOFRY, specific = create_beamline_wofry(slit_width=25e-6,slit_height=25e-6,source_offset=source_offset) #load_from_file="/scisoft/xop2.4/extensions/shadowvui/shadow3-scripts/HIGHLIGHTS/BEAMLINE.p")
        propagate_modes_wofry(beamlineWOFRY, specific, directory_name,maximum_mode=2)
