...
if __name__ == "__main__":
    ...
    filename = "/scisoft/xop2.4/extensions/shadowvui/shadow3-scripts/HIGHLIGHTS/NICE-NEW/propagation_wofry_EBS_15x15/propagated_beamline.npz"
    ...
    autocorrelation_function.save("rediagonalized_%s"%"wofry_EBS_15x15")
